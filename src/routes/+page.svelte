<script lang="ts">
	...
	import AdjustmentsHorizontal from '$lib/heroicons/24/outline/adjustments-horizontal.svelte'
	import AdjustmentsVertical from '$lib/heroicons/24/solid/adjustments-vertical.svelte'
	// Import the component from its size and icon type
	import { ArchiveBoxArrowDown } from '$lib/heroicons/20/solid'
	import { ArchiveBoxXMark } from '$lib/heroicons/24/outline'
	import { ArchiveBox } from '$lib/heroicons/24/solid'
	// Import the icon type from its size
	import { Solid as Solid20 } from '$lib/heroicons/20'
	import { Outline as Outline24, Solid as Solid24 } from '$lib/heroicons/24'
